...
for index, row in weather.iterrows():
    ...
    # ASTROLOGY TABLE
    cursor.execute(f"SELECT * FROM z_astrology WHERE weather_id='{weather_id}'")
    rows = cursor.fetchall()
