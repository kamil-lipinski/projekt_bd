...
#         "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Olsztyn/last30days"
#         "?unitGroup=metric&elements=datetime%2Cname%2Ctempmax%2Ctempmin%2Ctemp%2Cfeelslikemax%2Cfeelslikemin"
#         "%2Cfeelslike%2Cdew%2Chumidity%2Cprecip%2Cprecipprob%2Cprecipcover%2Cpreciptype%2Csnow%2Csnowdepth"
#         "%2Cwindgust%2Cwindspeed%2Cwinddir%2Cpressure%2Ccloudcover%2Cvisibility%2Csunrise%2Csunset%2Cmoonphase"
#         "%2Cconditions%2Cdescription&include=days&key=2LUQHNEL4NZN8LLPCZQRNVZ8D&contentType=csv")
#
...
for index, row in weather.iterrows():
    ...
    if len(rows) == 0:
        ...
        statement = ("INSERT INTO z_weather (city_id, datetime, tempmax, tempmin, temp, feelslikemax, feelslikemin, "
                     ...
                     "RETURNING weather_id into :22")
        cursor.execute(statement, (city_id, datetime, tempmax, tempmin, temp, feelslikemax, feelslikemin,
                                   feelslike, dew, humidity, precip, precipprob, precipcover, preciptype, snow,
        ...
        connection.commit()
        print(f"Weather on {datetime} in city with city_id: {city_id} not found in the database, "
        ...
        moonphase = astrology.iloc[index]['moonphase']
